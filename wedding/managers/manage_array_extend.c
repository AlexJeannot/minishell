...
int add_var_in_array(char **output_array, char** add_array, int count_add, int index_add)
{
...
int extend_array_with_var(char **output_array, char** add_array, int count_add, int index_add)
{
    int index_from;
    char **split_result;
